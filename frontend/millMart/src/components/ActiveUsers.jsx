...
// import { activateUser,InactivateUser,removeUser,fetchAllUsers } from '../slices/userSlice'
...
//             <div>
//                 <button className="text-sm border rounded-md bg-purple-500 hover:bg-purple-700 text-white py-1 px-3" onClick={()=>{setActivate(true)}}>ActivatedUsers</button>
//                 <button className="text-sm border rounded-md bg-purple-500 hover:bg-purple-700 text-white py-1 px-3" onClick={()=>{setActivate(false)}}>RequestedUsers</button>
//             {activate&&<div>
//             <h2 className="text-xl font-semibold mb-4">ActivateUser comp</h2>
...
//                     <td className="border border-gray-300 px-4 py-2"><button className="text-sm border rounded-md bg-orange-500 hover:bg-orange-700 text-white py-1 px-3" onClick={()=>{dispatch(InactivateUser(ele._id))}}>InActivate</button></td>
...
//            {!activate&&<div>
//             <h2 className="text-xl font-semibold mb-4">RequestedUser comp</h2>
...
//                     <td className="border border-gray-300 px-4 py-2">{ele.role}</td>
//                     <td className="border border-gray-300 px-4 py-2">{ele.isActive?'Active':'InActive'}</td>
//                     <td className="border border-gray-300 px-4 py-2"><button className="text-sm border rounded-md bg-green-500 hover:bg-green-700 text-white py-1 px-3" onClick={()=>{dispatch(activateUser(ele._id))}}>Active</button></td>
//                 </tr>)}
//             </table>
//             </div>} 
//             </div> 
