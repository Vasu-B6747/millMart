    ...
    <div className="w-64 bg-white shadow-md h-full hidden md:block">
      ...
      <nav className="mt-4">
        <ul className="space-y-2">
          ...
          {userData?.role === "admin" && (
            <li>
              <Link to="/equipments" className="block px-4 py-2 hover:bg-blue-100">
                Listings
              </Link>
            </li>
          )}
          ...
          {userData?.role === "seller" && (
            <li>
              <Link to="/dashboard/mylist" className="block px-4 py-2 hover:bg-blue-100">
                My Equipments
              </Link>
            </li>
          )}
          ...
          {userData?.role === "admin" && (
            <li>
              <Link to="/users" className="block px-4 py-2 hover:bg-blue-100">
                Users
              </Link>
            </li>
          )}
          ...
          <li>
            <Link to="/account" className="block px-4 py-2 hover:bg-blue-100">
              Profile
            </Link>
          </li>

          <li>
            <Link to="/chat" className="block px-4 py-2 hover:bg-blue-100">
              Messages
            </Link>
          </li>
